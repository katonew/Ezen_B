...
public class Ex4_배열 { //class s
	public static void main(String[] args) { //main s
		...
		//System.out.println("배열내 다섯번째 : "+ season[4]);		//오류 발생 : 인덱스4 없음
...
/*
	p.165
		...
		- 1. 선언
			1. 자료형타입[ ] 배열명 = {허용범위 내 데이터1,허용범위 내 데이터2,허용범위 내 데이터3,허용범위 내 데이터4};
